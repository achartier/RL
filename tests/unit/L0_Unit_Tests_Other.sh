...
if python -c "import sglang" 2>/dev/null; then
    SGLANG_TEST_PATHS=(
        "unit/models/generation/sglang/test_utils_smoke.py"
        "unit/models/generation/sglang/test_sglang_router.py"
        "unit/models/generation/sglang/test_sglang_worker_init.py"
        "unit/models/generation/sglang/test_sglang_launch.py"
        "unit/models/generation/sglang/test_sglang_worker_memory.py"
    )
